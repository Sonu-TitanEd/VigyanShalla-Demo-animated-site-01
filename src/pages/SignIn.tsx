        ...
        >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full pl-12 pr-12 py-3 bg-background border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary transition-all"
          ...
          <div className="grid grid-cols-2 gap-4">
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="flex items-center justify-center gap-2 px-4 py-3 bg-card border border-border rounded-xl hover:bg-muted transition-colors"
            >
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/20 to-coral-light/30 items-center justify-center p-8">
        ...
        >
          ...
          <p className="text-muted-foreground">
            Access hundreds of courses and join a community of passionate learners from around the world.
          </p>
        </motion.div>
      </div>
    </div>
